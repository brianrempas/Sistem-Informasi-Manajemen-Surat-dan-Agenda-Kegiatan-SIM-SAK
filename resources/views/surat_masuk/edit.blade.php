<x-app-layout>
    ...
    <h1 class="text-2xl font-semibold mb-6">Edit Surat Masuk</h1>
    ...
    <form action="{{ route('surat-masuk.update', $suratMasuk) }}" method="POST" enctype="multipart/form-data"
        ...
        <div>
            ...
            <input type="text" disabled value="{{ $suratMasuk->nomor_agenda }}"
        ...
        <div>
            ...
            <x-text-input id="nomor_surat_asal" class="mt-1 block w-full" name="nomor_surat_asal"
                value="{{ old('nomor_surat_asal', $suratMasuk->nomor_surat_asal) }}" required />
        ...
        <div>
            ...
            <x-text-input id="tanggal_surat" type="date" class="mt-1 block w-full" name="tanggal_surat"
        ...
        <div>
            ...
            <x-text-input id="tanggal_diterima" type="date" class="mt-1 block w-full" name="tanggal_diterima"
        ...
        <div>
            ...
            <x-text-input id="asal_surat" class="mt-1 block w-full" name="asal_surat"
        ...
        <div>
            ...
            <x-text-input id="perihal" class="mt-1 block w-full" name="perihal"
        ...
        <div>
            ...
            <select id="kategori_id" name="kategori_id" class="mt-1 block w-full rounded-lg border-gray-300">
                ...
                @foreach ($kategori as $kat)
                    <option value="{{ $kat->id }}" {{ old('kategori_id', $suratMasuk->kategori_id) == $kat->id ? 'selected' : '' }}>
                        {{ $kat->nama_kategori }}
                    </option>
                @endforeach
            </select>
        ...
        <div>
            ...
            <textarea id="isi_ringkas" name="isi_ringkas"
                class="mt-1 w-full rounded-lg border-gray-300">{{ old('isi_ringkas', $suratMasuk->isi_ringkas) }}</textarea>
        </div>
        ...
        <div>
            ...
            @if ($suratMasuk->lampiran_file)
                <p class="text-sm text-green-700 mt-2">
                    File saat ini: <a href="{{ asset('storage/' . $suratMasuk->lampiran_file) }}" target="_blank"
                        class="underline">Lihat Lampiran</a>
                </p>
            @endif
        ...
        <div>
            ...
            <select id="status_disposisi" name="status_disposisi" class="mt-1 block w-full rounded-lg border-gray-300">
                <option value="belum" {{ old('status_disposisi', $suratMasuk->status_disposisi) == 'belum' ? 'selected' : '' }}>Belum</option>
                <option value="proses" {{ old('status_disposisi', $suratMasuk->status_disposisi) == 'proses' ? 'selected' : '' }}>Proses</option>
                <option value="selesai" {{ old('status_disposisi', $suratMasuk->status_disposisi) == 'selesai' ? 'selected' : '' }}>Selesai</option>
            </select>
